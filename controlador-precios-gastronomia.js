...
function MostrarPrecioTotal()
{
  ...
  if (document.getElementById("P2").checked == true)
  {
      precio += 1500 * document.getElementById("cantP2").value;
  }
  if (document.getElementById("P3").checked == true)
  {
      precio += 1900 * document.getElementById("cantP3").value;
  }
  if (document.getElementById("P4").checked == true)
  {
      precio += 2800 * document.getElementById("cantP4").value;
  }
  if (document.getElementById("P5").checked == true)
  {
      precio += 2100 * document.getElementById("cantP5").value;
  }
  if (document.getElementById("P6").checked == true)
  {
      precio += 1500 * document.getElementById("cantP6").value;
  }
