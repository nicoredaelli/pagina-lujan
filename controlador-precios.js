...
function MostrarPrecioTotal()
{
  ...
  if (document.getElementById("P1").checked == true)
  {
      precio += 2500 * document.getElementById("cantP1").value;
  }

  if (document.getElementById("P2").checked == true)
  {
      precio += 4000 * document.getElementById("cantP2").value;
  }
  if (document.getElementById("P3").checked == true)
  {
      precio += 1500 * document.getElementById("cantP3").value;
  }
  if (document.getElementById("P4").checked == true)
  {
      precio += 2000 * document.getElementById("cantP4").value;
  }
  if (document.getElementById("P5").checked == true)
  {
      precio += 2500 * document.getElementById("cantP5").value;
  }
